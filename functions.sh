...
delete_blacklisted()
{
  BLACKLISTED_FILES=$(cat_file_from_url https://github.com/agolybev/AppImages/raw/${PKG2AICOMMIT}/excludelist | sed 's|#.*||g')
...
generate_status()
{
  ...
  wget -q -c "https://github.com/agolybev/AppImages/raw/${PKG2AICOMMIT}/excludedeblist"
